...
parser.add_argument('--image_idx', help='Directory of err indexes')

args = parser.parse_args()

#array of err indexes
err = []
...
CLASSES = (  # always index 0
    ...
    'sheep', 'sofa', 'train', 'tvmonitor', 'truck', 'airplane')
...
if __name__ == '__main__' :
    ...
    my_file = open(args.image_idx, 'w+')
    for idx in err:
        my_file.write(str(idx.split(',')[1])+"\n")
    my_file.close()
